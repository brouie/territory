...
// New deployment with 40/10/20/30 fee split (protocol/DAO/CL8Y/rewards)
export const ADDRESSES = {
  map: (process.env.NEXT_PUBLIC_MAP_ADDRESS ||
    "0x795f4c52331a358C38e0a8856b1AB548e988538e") as `0x${string}`,
  gameMaster: (process.env.NEXT_PUBLIC_GAME_MASTER_ADDRESS ||
    "0x45AEED21678572348373A5ecf0cba97842218962") as `0x${string}`,
  gold: (process.env.NEXT_PUBLIC_GOLD_ADDRESS ||
    "0x3c253AC9596306660c141cFb0E3c9261BacA9D4A") as `0x${string}`,
  combat: (process.env.NEXT_PUBLIC_COMBAT_ADDRESS ||
    "0x8234787587B9D40c833651d2A7501E5e2A925205") as `0x${string}`,
  spawn: (process.env.NEXT_PUBLIC_SPAWN_ADDRESS ||
    "0x5C55692316EbD9a4865e221dBf566EAA7b5A463F") as `0x${string}`,
  unitFactory: (process.env.NEXT_PUBLIC_UNIT_FACTORY_ADDRESS ||
    "0x81f8a522D346F6697B8441E871Ad7852431e1a4d") as `0x${string}`,
  feeCollector: (process.env.NEXT_PUBLIC_FEE_COLLECTOR_ADDRESS ||
    "0xACE9A3AE88a0242007437f310f7be5E6c216FFb8") as `0x${string}`,
} as const;
